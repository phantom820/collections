...
// NewForwardList creates a list with the specified elements. If no elements are specified an empty list is created.
func NewForwardList[T types.Equitable[T]](elements ...T) *ForwardList[T] {
...
// Front returns the front of the list l. Will panic if l has no front element.
...
// AddAt adds an element to list l at specified index i. Will panic if i is out of bounds.
...
// AddAll adds all elements from an iterable elements to the list l.
...
// RemoveAt removes the element at the specified index i in the list l. Will panic if index i is out of bounds.
...
// RemoveAll removes all the elements from list l that appear in iterable elements.
