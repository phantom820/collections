...
func TestDelete(t *testing.T) {
	...
	lessThan := func(i1, i2 int) bool { return i1 < i2 }
	defaultTree := func() *RedBlackTree[int, int] {
		tree := New[int, int](lessThan)
		tree.Insert(20, 1)
		tree.Insert(30, 1)
		tree.Insert(40, 1)
	...
	type deleteTest struct {
		input        *RedBlackTree[int, int]
		action       func(tree *RedBlackTree[int, int])
		expectedTree string
		expectedLen  int
	}
...
func TestUpdate(t *testing.T) {
	...
	defaultTree := func() *RedBlackTree[int, string] {
...
func TestKeys(t *testing.T) {
	...
	type keysTest struct {
		input    func() *RedBlackTree[int, struct{}]
		expected []int
	}
